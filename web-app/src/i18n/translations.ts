export const translations = {
  fr: {
    ...
    valueEfficiencyDesc: "Projets réalisés dans les délais",
    valueRespect: "Respect",
    valueRespectDesc: "Votre propriété traitée avec soin",
    valueTrust: "Confiance",
    valueTrustDesc: "Communication transparente",
    valueQuality: "Qualité",
    valueQualityDesc: "Travail d'artisan supérieur",
    ...
    formSubtitle: "Remplissez le formulaire et nous vous contacterons rapidement",
    formName: "Nom complet",
    formPhone: "Téléphone",
    formEmail: "Courriel",
    formCity: "Ville",
    formWorkType: "Type de travaux",
    formWorkTypePlaceholder: "Sélectionnez le type de travaux",
    formMessage: "Décrivez votre projet (optionnel)",
    ...
    workTypeRenovation: "Rénovation intérieur & extérieur",
    ...
    cert1: "Licence RBQ",
    cert2: "Assurance Responsabilité",
    cert3: "Garanties Écrites",
    cert4: "Service en Français et Anglais",
  ...
  en: {
    ...
    aboutText: "Construction Renovation JDS is a small family team specialized in residential renovations. We offer turnkey projects completed with efficiency, respect, and trust. Our mission is to create spaces you'll be proud of, focusing on quality and client satisfaction.",

    // Values
    valuesTitle: "Our Values",
    valueEfficiency: "Efficiency",
    valueEfficiencyDesc: "Projects completed on time",
    valueRespect: "Respect",
    valueRespectDesc: "Your property treated with care",
    valueTrust: "Trust",
    valueTrustDesc: "Transparent communication",
    valueQuality: "Quality",
    valueQualityDesc: "Superior craftsmanship",
    ...
    formSubtitle: "Fill out the form and we'll contact you soon",
    formName: "Full name",
    formPhone: "Phone",
    formEmail: "Email",
    formCity: "City",
    formWorkType: "Work type",
    formWorkTypePlaceholder: "Select work type",
    formMessage: "Describe your project (optional)",
    ...
    workTypeRenovation: "Interior & Exterior Renovation",
    ...
    cert1: "RBQ License",
    cert2: "Liability Insurance",
    cert3: "Written Warranties",
    cert4: "Service in French and English",
